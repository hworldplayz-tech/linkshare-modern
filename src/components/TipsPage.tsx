...
export default function TipsPage({ settings }: TipsPageProps) {
      ...
      <section className="pt-40 pb-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="max-w-3xl">
            ...
            >
              WhatsApp <span className="text-[#00a884]">Tips & Tricks</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Master WhatsApp with our expert guides, hidden secrets, and latest tutorials. 
              From privacy hacks to creative tricks, we've got you covered.
            </motion.p>
          ...
          {filteredTips.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredTips.map((tip, idx) => (
                ...
                >
                  <Link to={`/tips-tricks/${tip.slug}`} className="block relative aspect-[16/10] overflow-hidden">
                    <img 
                      src={tip.imageUrl} 
                      alt={tip.title}
                  ...
                  <div className="p-8 flex flex-col flex-1">
                    ...
                    <Link to={`/tips-tricks/${tip.slug}`}>
                      <h3 className="text-xl font-black text-gray-900 mb-4 group-hover:text-[#00a884] transition-colors leading-tight">
                        {tip.title}
                      </h3>
                    </Link>
          ...
          <div className="bg-[#00a884] rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl shadow-[#00a884]/20">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              <h2 className="text-4xl md:text-5xl font-black text-white mb-6 tracking-tight">
                Want More WhatsApp Secrets?
              </h2>
              <p className="text-white/80 text-lg mb-10">
                Join our newsletter to receive the latest WhatsApp tips, tricks, and updates directly in your inbox.
              </p>
