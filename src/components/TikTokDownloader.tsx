...
export const TikTokDownloader: React.FC = () => {
  ...
  return (
    <div className="space-y-12">
      {/* --- Main Box --- */}
      <div className="bg-white rounded-[2.5rem] border border-gray-100 p-6 md:p-10 shadow-sm relative overflow-hidden">
        ...
        {activeTab === 'downloader' && (
          <div className="space-y-8">
            ...
            <div className="relative">
              <div className="flex flex-col sm:flex-row items-center gap-3 bg-gray-50 p-2.5 sm:p-3 rounded-2xl sm:rounded-3xl border border-gray-200 focus-within:border-[#00a884] focus-within:bg-white focus-within:ring-4 focus-within:ring-[#00a884]/10 transition-all shadow-inner">
                <div className="flex items-center gap-3 w-full pl-3">
                  <Video className="w-6 h-6 text-gray-400 flex-shrink-0" />
                  <input
                    type="url"
                    value={url}
                    onChange={(e) => {
                    ...
                    placeholder="Paste TikTok video or photo link here (e.g. https://www.tiktok.com/@...)"
                    className="w-full bg-transparent text-gray-800 placeholder-gray-400 text-sm sm:text-base outline-none font-medium py-2"
                  />
                  {url && (
                    <button
                      onClick={() => {
                ...
                <div className="w-full sm:w-auto flex items-center gap-2">
                  <button
                    onClick={handlePaste}
                    className="sm:hidden flex-1 py-3 bg-white text-gray-700 text-xs font-bold rounded-2xl border border-gray-200 text-center flex items-center justify-center gap-1.5"
                  >
                    <Copy className="w-3.5 h-3.5" />
                    Paste
                  </button>
                  <Button
                    onClick={() => handleFetch()}
                    disabled={loading}
                    className="w-full sm:w-auto px-8 py-3.5 sm:py-4 bg-[#00a884] hover:bg-[#008f6f] text-white font-black text-sm sm:text-base rounded-2xl shadow-lg shadow-[#00a884]/25 flex items-center justify-center gap-2.5 transition-all flex-shrink-0 h-auto"
                  >
                    {loading ? (
                      <>
              ...
              <div className="mt-4 flex flex-wrap items-center gap-2 text-xs text-gray-500">
                <span className="font-semibold text-gray-400">Quick Test Examples:</span>
                {SAMPLE_TIKTOK_LINKS.map((sample, idx) => (
                  <button
                    ...
                    className="px-3 py-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl font-medium transition-all text-[11px]"
                  >
                    {sample.label}
                  </button>
                ))}
                ...
                >
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-xs text-red-500 mt-2">
                      Tip: Ensure the TikTok account is not private and the URL format is correct (e.g. from the TikTok app Share &gt; Copy Link button).
                    </p>
                  </div>
                </motion.div>
              )}
            ...
            {videoData && (
              <motion.div
                ...
                className="bg-gray-50 border border-gray-200/80 rounded-[2.5rem] p-6 md:p-8 space-y-8"
              >
                {/* Author Info & Header */}
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 border-b border-gray-200">
                  <div className="flex items-center gap-4">
                    <div className="relative">
                      ...
                      />
                      <span className="absolute bottom-0 right-0 w-4 h-4 bg-[#00a884] rounded-full border-2 border-white flex items-center justify-center text-[9px] text-white font-bold">
                        ✓
                      </span>
                    </div>
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="px-2 py-0.5 bg-gray-200/80 text-gray-600 rounded-full text-[10px] font-bold">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-1.5 text-xs font-bold text-[#00a884] hover:underline"
                  >
                    View TikTok Profile <ExternalLink className="w-3.5 h-3.5" />
                  </a>
                </div>

                {/* Caption / Title */}
                {videoData.title && (
                  <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex items-start justify-between gap-4">
                    <p className="text-sm text-gray-700 leading-relaxed font-medium">
                      {videoData.title}
                    </p>
                    <button
                      onClick={() => handleCopy(videoData.title, 'caption')}
                      className="p-2 text-gray-400 hover:text-[#00a884] hover:bg-emerald-50 rounded-xl transition-all flex-shrink-0"
                      title="Copy Caption"
                    >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  <div className="bg-white p-3.5 rounded-2xl border border-gray-100 text-center shadow-sm">
                    ...
                    <span className="text-base font-black text-gray-900">{formatNumber(videoData.stats.likes)}</span>
                  </div>
                  <div className="bg-white p-3.5 rounded-2xl border border-gray-100 text-center shadow-sm">
                    <div className="flex items-center justify-center gap-1.5 text-blue-500 mb-1">
                      <Eye className="w-4 h-4" />
                      <span className="text-xs font-bold text-gray-400">Views</span>
                    </div>
                    <span className="text-base font-black text-gray-900">{formatNumber(videoData.stats.plays)}</span>
                  </div>
                  <div className="bg-white p-3.5 rounded-2xl border border-gray-100 text-center shadow-sm">
                    <div className="flex items-center justify-center gap-1.5 text-amber-500 mb-1">
                      <MessageCircle className="w-4 h-4" />
                      <span className="text-xs font-bold text-gray-400">Comments</span>
                    </div>
                    <span className="text-base font-black text-gray-900">{formatNumber(videoData.stats.comments)}</span>
                  </div>
                  <div className="bg-white p-3.5 rounded-2xl border border-gray-100 text-center shadow-sm">
                    <div className="flex items-center justify-center gap-1.5 text-emerald-500 mb-1">
                      <Share2 className="w-4 h-4" />
                      <span className="text-xs font-bold text-gray-400">Shares</span>
                    </div>
                    <span className="text-base font-black text-gray-900">{formatNumber(videoData.stats.shares)}</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                  ...
                  <div className="lg:col-span-5 flex flex-col items-center">
                    <div className="w-full max-w-sm bg-black rounded-3xl overflow-hidden shadow-2xl border border-gray-800 relative group aspect-[9/16] flex items-center justify-center">
                  ...
                  <div className="lg:col-span-7 space-y-5">
                    ...
                    <div className="space-y-3">
                      <button
                        ...
                        className="w-full p-4 sm:p-5 bg-gradient-to-r from-[#00a884] to-[#008f6f] hover:from-[#008f6f] hover:to-[#007b5e] text-white rounded-2xl shadow-xl shadow-[#00a884]/20 flex items-center justify-between group transition-all"
                      >
                        <div className="flex items-center gap-3 text-left">
                          ...
                          <div>
                            <div className="font-black text-base sm:text-lg flex items-center gap-2">
                              <span>Download Without Watermark (HD)</span>
                              <span className="px-2 py-0.5 bg-white/30 text-white rounded-md text-[10px] font-extrabold uppercase">
                                Best Quality
                              </span>
                            </div>
                            <p className="text-xs text-emerald-100 mt-0.5">
                              MP4 Format • Crystal Clear HD 1080p/720p • Direct Save
                            </p>
                          </div>
                        </div>
                        <Download className="w-6 h-6 text-white flex-shrink-0 group-hover:translate-y-0.5 transition-transform" />
                      </button>
                      ...
                      {videoData.playUrl && (
                        <button
                          ...
                          className="w-full p-4 bg-white hover:bg-gray-50 border-2 border-gray-200 hover:border-[#00a884] text-gray-800 rounded-2xl flex items-center justify-between group transition-all"
                        >
                          <div className="flex items-center gap-3 text-left">
                            <div className="w-10 h-10 bg-gray-100 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-[#00a884]/10 group-hover:text-[#00a884] transition-colors">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-400 mt-0.5">
                                Optimized MP4 stream for fast download on mobile connections
                              </p>
                            </div>
                          </div>
                          <Download className="w-5 h-5 text-gray-400 group-hover:text-[#00a884] transition-colors" />
                        </button>
                      )}
                        ...
                        <div className="bg-white p-4 rounded-2xl border border-gray-200 space-y-3">
                          <div className="flex items-center justify-between">
                            ...
                            <button
                              ...
                              className="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-xl text-xs font-bold flex items-center gap-1.5 shadow-md shadow-purple-600/20 transition-all flex-shrink-0"
                            >
                      ...
                      {(videoData.originCover || videoData.cover) && (
                        <button
                          ...
                          className="w-full p-3.5 bg-white hover:bg-gray-50 border border-gray-200 text-gray-700 rounded-2xl flex items-center justify-between text-xs font-bold transition-all"
                        >
                          <span className="flex items-center gap-2">
                            <ImageIcon className="w-4 h-4 text-gray-400" />
                            Download Video HD Thumbnail (JPG)
                          </span>
                    ...
                    {videoData.images && videoData.images.length > 0 && (
                      <div className="pt-4 border-t border-gray-200 space-y-3">
                        <div className="flex items-center justify-between">
                          <h5 className="font-black text-sm text-gray-900 flex items-center gap-2">
                            <ImageIcon className="w-4 h-4 text-[#00a884]" />
                            Photo Slideshow Images ({videoData.images.length})
                          </h5>
                          <button
                            onClick={() => {
        ...
        {activeTab === 'history' && (
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-xl font-black text-gray-900">Recent Download History</h3>
                <p className="text-xs text-gray-500">
            ...
            {history.length === 0 ? (
              <div className="text-center py-16 bg-gray-50 rounded-3xl border border-gray-100">
                ...
                <h4 className="font-bold text-gray-800">No Download History Yet</h4>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {history.map((item) => (
                  <div
                    key={item.id}
                    className="bg-gray-50 hover:bg-gray-100/80 border border-gray-200/80 rounded-2xl p-3.5 flex flex-col justify-between transition-all group"
                  >
                    <div className="flex items-start gap-3">
                      <div className="w-16 h-20 bg-gray-200 rounded-xl overflow-hidden flex-shrink-0 relative">
                        {item.cover ? (
                          <img
                            src={item.cover}
                            alt={item.title}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[11px] text-gray-500 mt-1">@{item.username}</p>
                        <p className="text-[10px] text-gray-400 mt-0.5">{item.downloadedAt}</p>
                      </div>
                      <button
                    ...
                    <div className="mt-3 pt-3 border-t border-gray-200 flex items-center gap-2">
                      <button
                        ...
                        className="flex-1 py-2 bg-[#00a884] hover:bg-[#008f6f] text-white rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 shadow-sm transition-all"
                      >
                      ...
                      {item.musicUrl && (
                        <button
                          ...
                          className="p-2 bg-purple-100 hover:bg-purple-200 text-purple-700 rounded-xl"
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gray-50 p-6 rounded-3xl border border-gray-100 flex flex-col items-center text-center">
                <div className="w-14 h-14 bg-[#00a884]/10 text-[#00a884] rounded-2xl flex items-center justify-center font-black text-xl mb-4">
                  1
                </div>
                <h4 className="font-bold text-gray-900 mb-2">Copy TikTok Link</h4>
              ...
              <div className="bg-gray-50 p-6 rounded-3xl border border-gray-100 flex flex-col items-center text-center">
                ...
                <h4 className="font-bold text-gray-900 mb-2">Paste the Link</h4>
                <p className="text-xs text-gray-500 leading-relaxed">
              ...
              <div className="bg-gray-50 p-6 rounded-3xl border border-gray-100 flex flex-col items-center text-center">
                ...
                <h4 className="font-bold text-gray-900 mb-2">Save No Watermark MP4</h4>
                <p className="text-xs text-gray-500 leading-relaxed">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex flex-col items-start">
          <div className="w-12 h-12 bg-emerald-50 text-[#00a884] rounded-2xl flex items-center justify-center mb-4">
            <Zap className="w-6 h-6" />
          </div>
          <h4 className="font-black text-gray-900 text-base mb-1">100% Watermark Free</h4>
          <p className="text-xs text-gray-500 leading-relaxed">
        ...
        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex flex-col items-start">
          ...
          <h4 className="font-black text-gray-900 text-base mb-1">Android, iOS & PC</h4>
          <p className="text-xs text-gray-500 leading-relaxed">
            Works smoothly on iPhone (Safari/Files), Android (Chrome/Gallery), Windows, and Mac without installing extra apps.
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex flex-col items-start">
          ...
          <h4 className="font-black text-gray-900 text-base mb-1">Extract MP3 Audio</h4>
          <p className="text-xs text-gray-500 leading-relaxed">
        ...
        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex flex-col items-start">
          ...
          <h4 className="font-black text-gray-900 text-base mb-1">Unlimited & Free</h4>
          <p className="text-xs text-gray-500 leading-relaxed">
      ...
      <div className="bg-white rounded-[2.5rem] border border-gray-100 p-8 md:p-12 shadow-sm space-y-6">
        <div className="flex items-center gap-3 mb-6">
          <div className="w-10 h-10 bg-[#00a884]/10 text-[#00a884] rounded-xl flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
            <h4 className="font-bold text-gray-900 text-sm mb-2">Do I need to pay or install an app?</h4>
            <p className="text-xs text-gray-500 leading-relaxed">
          ...
          <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
            <h4 className="font-bold text-gray-900 text-sm mb-2">Where are downloaded videos saved on iPhone?</h4>
            <p className="text-xs text-gray-500 leading-relaxed">
          ...
          <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
            <h4 className="font-bold text-gray-900 text-sm mb-2">Can I download TikTok photo slideshows?</h4>
            <p className="text-xs text-gray-500 leading-relaxed">
          ...
          <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
            <h4 className="font-bold text-gray-900 text-sm mb-2">Can I download private TikTok videos?</h4>
            <p className="text-xs text-gray-500 leading-relaxed">
