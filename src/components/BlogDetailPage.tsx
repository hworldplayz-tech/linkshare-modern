...
export default function BlogDetailPage({ settings }: BlogDetailPageProps) {
  ...
  React.useEffect(() => {
    ...
    // Run custom global JS scripts, ad networks (Adsterra, Google AdSense), and inline handlers
      ...
      for (const oldScript of externalScripts) {
        ...
        const handleWrite = (...args: any[]) => {
          ...
          try {
            ...
            console.error('Error handling document.write in ad script:', e);
          }
        };
  ...
  React.useEffect(() => {
    ...
    const handleLinkClick = (e: MouseEvent) => {
      ...
      if (anchor) {
        ...
        // Skip link hijacking if it's a hash, javascript action, download, target="_blank", or custom button handler
        if (
          !rawHref ||
          rawHref === '#' ||
          rawHref.startsWith('#') ||
